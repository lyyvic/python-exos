...
Adam KACHER
18/12/2023
To do : - Séparer le main avec un fichier interface
        - Compatibilité avec le fichier Motus """
...
def boucle_principale(): #Boucle principal qui va définir les actions automatiques de la partie

    global jeu

    if jeu: #Si le jeu est lancé

        jeu.choix_mot
        jeu.affiche_mot
        jeu.jeu

    Mafenetre.after(50, boucle_principale) #Relance la boucle avec un délais de 50 ms


#Lancement du programme 
Mafenetre.after(50, boucle_principale)
Mafenetre.mainloop()
